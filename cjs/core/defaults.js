...
const SHAPE_TAGS = ['path', 'circle', 'rect', 'ellipse', 'line', 'polygon', 'polyline']
 ...
 */
function resolveStrokeWidth(base, strokeWidth, absolute, size, viewBox) {
